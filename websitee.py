...
while True:
    ...
    if "THA" in art_zug_zv1:
        ...
        if "VRS-Tarif" in sparpreis_zv1:
            ...
            with open ('test_code.csv','a', newline='') as f:
                writer= csv.writer(f, delimiter=';')
                writer.writerow([anfrage,alter_1,bahnkarteneu,start,ziel,datum,abfahrt_zv1,ankunft_zv1,art_zug_zv1,sparpreis2_zv1])
